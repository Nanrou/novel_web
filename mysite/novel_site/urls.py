...
urlpatterns = [
    ...
    url(r'^m/$', include([
        ...
        url(r'^cate/quanben/$', views.QuanbenView.as_view(), name='m_quanben'),
        url(r'^cate/(?P<cate>[a-z]+)/$', views.CategoryView.as_view(), name='m_category'),
        url(r'^info/(?P<pk>[0-9]+)/$', views.InfoView.as_view(), name='m_info'),
        url(r'^book/(?P<pk>[0-9]+)/(?P<index>[0-9]+)/$', views.BookView.as_view(), name='m_detail'),
    ])),
]